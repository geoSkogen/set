  ...
  constructor(quantities_int_arr, colors_str_arr, qualities_str_arr, chars_arr) {
    if (typeof Card === 'object') {
      ...
      //
        ...
        console.log('The Deck::constructor expects four arrays as arguments')
      }
    } else {
      console.log('The Deck::constructor requires a Card class definition.')
    }
  }
